...
"TO_TIMESTAMP"("finish" / 1000.0) AS "finishTime",
  "outcome", "outcomeReason", UPPER("username") AS "username", "inputRecords", "inputBytes", "outputRecords", "outputBytes", "requestType", "queryType", "parentsList", "accelerated", "queryCost", "queueName", "poolWaitTime", "pendingTime", "metadataRetrievalTime", "planningTime", "engineStartTime", "executionPlanningTime", "startingTime","context","engineName",
